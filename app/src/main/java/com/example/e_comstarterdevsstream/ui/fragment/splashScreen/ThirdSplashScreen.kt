...
class ThirdSplashScreen : Fragment(R.layout.third_splash_screen) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val skip = view.findViewById<TextView>(R.id.btnSkip3)
        val start = view.findViewById<TextView>(R.id.btnStart)
